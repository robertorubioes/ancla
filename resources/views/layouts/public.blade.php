...
<head>
    ...
    <title>{{ config('app.name', 'ANCLA') }} - Document Verification</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-4">
                    <a href="/" class="flex items-center">
                        ...
                        <span class="ml-2 text-xl font-bold text-gray-900">{{ config('app.name', 'ANCLA') }}</span>
                    </a>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-500">
                            {{ config('app.name', 'ANCLA') }} provides secure electronic signature services 
                ...
                <div class="mt-8 pt-8 border-t text-center">
                    <p class="text-sm text-gray-400">
                        &copy; {{ date('Y') }} {{ config('app.name', 'ANCLA') }}. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
