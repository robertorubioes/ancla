<div class="max-w-5xl mx-auto py-6 px-4">
    ...
    <div class="flex gap-3 mb-4">
        <input type="search" wire:model.live.debounce.300ms="search" placeholder="{{ __('Buscar...') }}"
            class="flex-1 rounded-md border border-gray-300 text-sm focus:border-purple-500 focus:ring-purple-500">
        <select wire:model.live="statusFilter" class="rounded-md border border-gray-300 text-sm focus:border-purple-500 focus:ring-purple-500">
            ...
            <div class="bg-white rounded-xl shadow-xl w-full max-w-lg p-6 relative z-10">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="newName" class="w-full rounded-md border border-gray-300 text-sm focus:border-purple-500 focus:ring-purple-500">
                        @error('newName')
                            <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
